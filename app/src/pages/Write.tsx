  ...
  return (
    <div className="min-h-screen bg-bg-primary pt-24 px-4 pb-12">
      <div className="mx-auto max-w-6xl">
        <h1 className="text-3xl font-bold text-text-primary mb-2">Write Options</h1>
        <p className="text-text-secondary mb-8">Write new options or manage your resale listings.</p>
